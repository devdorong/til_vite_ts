...
- https://supabase.com/dashboard/project/ukunsknavgnzobcmjqqp/auth/users
...
export const supabase = createClient(supabaseUrl, supabaseAnonKey, {
  auth: {
    ...
    // 사용자 세션정보를 localStorage 에 저장해서 웹브라우저 새로고침시에도 로그인 유지
    persistSession: true,
...
- /src/contexts/AutoContext.tsx 파일 생성
